...
// Simulate fetch with random error option
  ...
  return new Promise((resolve, reject) => {
    setTimeout(() => {
      if (Math.random() < failRate) {
        ...
        // return a deep copy so consumers can mutate
...
// small line chart generator: returns 30 numbers and draws an SVG polyline
...
export default function App() {
  ...
  // auto refresh 'last updated' display interval
  useEffect(() => {
  ...
  const load = (opts = {}) => {
    ...
    fetchDummyData(opts)
      .then((resp) => {
        // set lastUpdatedTimestamp to now to simulate fresh data
